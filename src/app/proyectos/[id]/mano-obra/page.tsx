    ...
    <div className="flex flex-col min-h-[calc(100vh-52px)] dark:bg-slate-950 bg-slate-50">
      ...
      <div className="sticky top-[52px] z-30 dark:bg-slate-950/95 bg-white/95 backdrop-blur-md border-b dark:border-white/[0.06] border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs dark:text-slate-500 text-slate-400">Módulo 4 · En desarrollo</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-5 py-24 px-6">
        <div className="w-16 h-16 rounded-2xl bg-orange-500/10 flex items-center justify-center">
          <Clock className="w-7 h-7 dark:text-orange-400 text-orange-600" />
        </div>
        <div className="text-center max-w-sm">
          ...
          <p className="text-sm dark:text-slate-400 text-slate-500 mt-2 leading-relaxed">
            El módulo de Gestión de Mano de Obra estará disponible próximamente. Aquí podrás
            controlar contratos por cuadrilla, personal asignado, retenciones de garantía, pagos
            realizados y saldo pendiente.
          </p>
        </div>
        <Link
          href={`/proyectos/${id}`}
