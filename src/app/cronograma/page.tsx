      ...
      <div className="sticky top-0 z-40 border-b dark:border-white/[0.06] border-slate-200 dark:bg-slate-950/80 bg-white/80 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            <CalendarDays size={15} className="dark:text-violet-400 text-violet-600" />
            <div className="leading-none">
              <p className="text-sm font-semibold dark:text-slate-100 text-slate-800">Cronograma y Avances</p>
              <p className="text-[11px] dark:text-slate-500 text-slate-400">Módulo 3</p>
            </div>
          </div>
        </div>
      </div>
      <main className="flex-1 flex items-center justify-center">
        <div className="flex flex-col items-center gap-4 text-center px-6">
          <div className="w-16 h-16 rounded-2xl bg-violet-500/10 flex items-center justify-center">
            <Construction size={28} className="dark:text-violet-400 text-violet-600" />
          </div>
          <div>
            ...
            <p className="text-sm dark:text-slate-400 text-slate-500 mt-1">
              Cronograma y Avances estará disponible próximamente.
            </p>
          </div>
        </div>
      </main>
